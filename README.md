...
* un_quota_check.bat : 클릭 한 번으로 가상환경 구축, 패키지 설치 및 조회를 실행하는 배치 파일.
...
2. **할당량 확인 실행**
   un_quota_check.bat 파일을 더블 클릭하여 실행합니다. 
   - 처음 실행 시 자동으로 Python 가상환경을 생성하고 필요한 패키지(equirements.txt)를 설치합니다. 
